...
std::string get_nl80211_cmd(nl80211_commands cmd) {
    switch (cmd) {
        ...
        case NL80211_CMD_START_AP: return "NL80211_CMD_START_AP/NL80211_CMD_NEW_BEACON";
        // case NL80211_CMD_NEW_BEACON: return "NL80211_CMD_NEW_BEACON";
        case NL80211_CMD_STOP_AP: return "NL80211_CMD_STOP_AP/NL80211_CMD_DEL_BEACON";
        ...
        case NL80211_CMD_REGISTER_FRAME: return "NL80211_CMD_REGISTER_FRAME/NL80211_CMD_REGISTER_ACTION";
        // case NL80211_CMD_REGISTER_ACTION: return "NL80211_CMD_REGISTER_ACTION/";
        case NL80211_CMD_FRAME: return "NL80211_CMD_FRAME/NL80211_CMD_ACTION";
        // case NL80211_CMD_ACTION: return "NL80211_CMD_ACTION";
        case NL80211_CMD_FRAME_TX_STATUS: return "NL80211_CMD_FRAME_TX_STATUS/NL80211_CMD_ACTION_TX_STATUS";
        ...
        case NL80211_CMD_LINKS_REMOVED: return "NL80211_CMD_LINKS_REMOVED/NL80211_CMD_MAX";
        case __NL80211_CMD_AFTER_LAST: return "__NL80211_CMD_AFTER_LAST";
        // case NL80211_CMD_MAX: return "NL80211_CMD_MAX";
        default: return "Unknown NL80211_CMD";
    }
}
